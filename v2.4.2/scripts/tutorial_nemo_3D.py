# # Nemo 3D tutorial
from parcels import FieldSet, ParticleSet, JITParticle, AdvectionRK4_3D, download_example_dataset
...
depth_level = 8
print(f"Level[{int(depth_level)}] depth is: [{fieldset.W.grid.depth[depth_level]:g} {fieldset.W.grid.depth[depth_level+1]:g}]")
plt.figure()
